...
import styled from './TextOptionCard.module.css';




const TextOptionCard = ({ item, ind, currentQuestionNumber, answersArr, setAnswersArr, clickedOptionQuestionNumber, setClickedOptionQuestionNumber }) => {
