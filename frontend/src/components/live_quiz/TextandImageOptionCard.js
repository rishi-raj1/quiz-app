...
import styled from './TextandImageOptionCard.module.css';




const TextandImageOptionCard = ({ ind, item1, item2, currentQuestionNumber, answersArr, setAnswersArr, clickedOptionQuestionNumber, setClickedOptionQuestionNumber }) => {
    ...
    return (
        <div className={styled.container} onClick={clickHandler}>
            <span>{item1}</span>
            <img src={item2} alt='bird' className={styled.image} />
        </div>
    )
}

export default TextandImageOptionCard