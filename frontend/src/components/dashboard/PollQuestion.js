...
import styled from './PollQuestion.module.css';
...
const PollQuestion = () => {
    ...
    const createHandler = async () => {
        ...
        for (let i = 0; i < len; i++) {
            const { questionName, optionType, textOptionsArr, imageOptionsArr } = newQuestionsArr[i];
        ...
        <div className={styled.container}>
            <div className={styled.centeredDiv}>
                ...
                <div className={styled.secondDiv}>
                    <input name='questionName' placeholder='Poll Question' onChange={inputHandler} value={currentObj.questionName} />
                </div>
